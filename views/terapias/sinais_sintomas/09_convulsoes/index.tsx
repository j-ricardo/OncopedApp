...
export default function ViewConvulsoesSinaisSintomas({ navigation }: any){
    ...
    function handler(){
        ...
        const nav: string = ViewReturnedInBackPress(21);
                                ...
                                >
                                    ...
                                    >     
                                        ...
                                        >
                                            ...
                                            /> 
                                            <Text>
                                                {" "}Se o(a) paciente estiver em pé,
                                                tentar auxiliar para que ele(a) não
                                                caia de maneira brusca no chão e
                                                livrar a região de obstáculos;
                                            </Text>  
                                        </Text>
                                        <Text 
                                            style={{ 
                                        ...
                                        >
                                            ...
                                            /> 
                                            <Text>
                                                {" "}Posicionar o(a) paciente
                                                lateralmente para evitar o risco de
                                                aspirar algum objeto ou secreção;
                                            </Text>  
                                        </Text>
                                        <Text 
                                            style={{ 
                                        ...
                                        >
                                            ...
                                            /> 
                                            <Text>
                                                {" "}Cronometrar o período de
                                                duração da crise convulsiva e
                                ...
                                >
                                    ...
                                    >     
                                        ...
                                        >
                                            ...
                                            />
                                            <Text>
                                                {" "}Introduzir a mão ou algum
                                                objeto na boca, tentando evitar a
                                                aspiração;
                                            </Text>  
                                        </Text>
                                        <Text 
                                        ...
                                        >
                                            ...
                                            /> 
                                            <Text>
                                                {" "}Passar alguma substância
                                                (vinagre, álcool, água…) no(a)
                                                paciente na intenção de cessar o
                                                episódio. 
                                            </Text>  
                                        </Text>
                                    </View>
