...
export default function ViewNeuropatiasSinaisSintomas({ navigation }: any){
    ...
    Navegacao(25, 'ViewNeuropatiasSinaisSintomas'); 

    useBackButton(handler);   

    function handler(){
        console.log('backpress');
        const nav: string = ViewReturnedInBackPress(25);
                        ...
                        <Center> 
                            ...
                            >                            
                                <Image               
                                    ...
                                    source={require('../../../../assets/ICO_SINAIS_E_SINTOMAS/13_NEUROPATIAS.png')} 
                                />
                            </TouchableOpacity>
                            <View
                                style={{
                            ...
                            >
                                ...
                                >
                                    ...
                                    >                                        
                                        ...
                                        >
                                            Quando alguns agentes
                                            quimioterápicos atingem as
                                            células do sistema
                                            neurológico;
                                        </Text>
                                    </View>
